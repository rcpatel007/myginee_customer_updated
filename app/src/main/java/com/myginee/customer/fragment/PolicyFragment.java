...
public class PolicyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvScreenTitle.setText("Privacy Policy");
...
//            }
    ...
    private void getAboutUsFromAPI() {
        ...
        Call<ResponseBody> getTermsNConditionCall = GineeAppApi.api().termsNconditionAPI(/*GineePref.getAccessToken(getActivity())*/);
        getTermsNConditionCall.enqueue(new retrofit2.Callback<ResponseBody>() {
            @Override
...
//                                    tvTitle.setText(item.getString("title"));
                                    tvDesc.setText(item.getString("terms"));
