...
public class WishListModel {
    ...
    @SerializedName("data")
    @Expose
    private List<WishListModel.Datum> data = null;
    ...
    public List<WishListModel.Datum> getData() {
        return data;
    }

    public void setData(List<WishListModel.Datum> data) {
        this.data = data;
    }

    public static class Datum implements Serializable
    {
        public Datum(ArrayList<String> imageUrls, String id, String name, String imageUrl,
